...
<p>This project will contain all the helpful extensions I collected or developed.</p>
<p>Each extension will have the script separate for the bookmark (or Tampermonkey autoscript) as well.</p>
